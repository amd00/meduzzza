...
namespace Meduzzza
{
	...
	MeduzzzaCommonWidget::MeduzzzaCommonWidget(MainWindow *_mw) : QWidget(), m_base_ui(new Ui::MeduzzzaCommonWidget), 
			m_man(Manager::get()), m_mw(_mw), m_started(false), m_paused(false)
	{
		m_base_ui -> setupUi(this);
	...
	MeduzzzaCommonWidget::~MeduzzzaCommonWidget() 
	{
		delete m_base_ui;
	}
